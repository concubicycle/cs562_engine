...
renderer::opengl_model renderer::assimp_vram_loader::load_rigged_model(const asset::assimp_scene_asset& scene)
{
  auto cached = _model_cache.find(scene.aiscene);
  if (cached != _model_cache.end())
    return cached->second;

  asset::assimp_model<asset::rigged_mesh> model_asset(scene.aiscene, _loader);
  opengl_model& result = _model_cache[scene.aiscene];
...
renderer::opengl_mesh renderer::assimp_vram_loader::load_mesh(const asset::rigged_mesh& mesh)
{
  using namespace gl;
  ...
  glEnableVertexAttribArray(2);
  glVertexAttribPointer(2, 2, GL_FLOAT, GL_FALSE, sizeof(asset::rigged_vertex), (void*)offsetof(asset::rigged_vertex, texture_coords));
  glEnableVertexAttribArray(3);
  ...
  glEnableVertexAttribArray(5);
  glVertexAttribPointer(5, 4, GL_FLOAT, GL_FALSE, sizeof(asset::rigged_vertex), (void*)offsetof(asset::rigged_vertex, color));
  glEnableVertexAttribArray(6);
  glVertexAttribIPointer(6, 4, GL_INT, sizeof(asset::rigged_vertex), (void*)offsetof(asset::rigged_vertex, bone_ids));
  glEnableVertexAttribArray(7);
  glVertexAttribPointer(7, 4, GL_FLOAT, GL_FALSE, sizeof(asset::rigged_vertex), (void*)offsetof(asset::rigged_vertex, weights));
