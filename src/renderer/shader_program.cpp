...
void renderer::shader_program_base::set_mat4_array(int const location, const std::vector<Eigen::Matrix4f>& array) const
{
  using namespace gl;
  glUniformMatrix4fv(location, array.size(), GL_FALSE, array[0].data());
}